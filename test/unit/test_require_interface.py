...
class RequireCharm(CharmBase):
    def __init__(self, *args):
        super().__init__(*args)
        self.interface = RequireAppInterface(self, "app-requires", "test/unit/test_schema.yaml")
...
def test_require():
    ...
    data = {"service": "my-service", "port": 4242, "access-key": "my-access-key", "secret-key": "my-secret-key"}
    harness.update_relation_data(
        rel_id, "test-app2", {"data": yaml.dump(data)}
    )
